        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Halaman Buat Akun</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <form action="/superadmin/admincontrol" method="post">
                  @csrf
                  
                    <div class="card-body">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Nama</label>
                          <input  name="name" class="form-control" id="exampleInputEmail1" placeholder="Nama">
                        </div>
                      <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="type" style="width: 100%;">
                      ...
                      <option value="5">Sarana Prasana</option>
                      <option value="2">Kemahasiswaan</option>
                      <option value="8">Umum</option>
                      <option value="6">Direksi</option>
                      {{-- /* Users: 0=>Mahasiswa, 1=>SuperAdmin, 2=>Kemahasiswaan, 3=>Akademik ,4=>Kamsisdal, 5=>Sarpras, 6=>Direksi, 7=>Keuangan, 8=>umum, */ --}}
                    </select>
                  </div>
                  <!-- /.form-group -->
