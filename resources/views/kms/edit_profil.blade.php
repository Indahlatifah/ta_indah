            ...
            <div class="col-md-4">
              ...
              <div class="card card-primary card-outline">
                <div class="card-body box-profile">
                  ...
                  <form action="/mahasiswa/edit_profil/{{ $user->id }}/update" method="POST">
                    @csrf
                    @method('PUT')
                  ...
                  {{-- <a href="/mhsadmin/edit_profil/" class="btn btn-primary btn-block"><b>Ubah</b></a> 
             ...
             <div class="col-md-4">
               ...
               <div class="card card-primary card-outline">
                 <div class="card-body box-profile">
                   ...
                   <form action="/kemahasiswaan/edit_profil/{{ $user->id }}/update" method="POST">
                     @csrf
                     @method('PUT')
