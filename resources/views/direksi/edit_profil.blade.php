...
<div class="wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Halaman Ubah Profil</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-4">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <form action="/direksi/edit_profil/{{ $user->id }}/update" method="POST">
                  @csrf
                  @method('PUT')
                ...
                {{-- <a href="/direksi/edit_profil/" class="btn btn-primary btn-block"><b>Ubah</b></a> --}}
  ...
  <!-- /.content-wrapper -->
      ...
      <!-- footer -->
      @include('direksi.direksipartials.footer')
      <!-- footer -->
