...
<div class="wrapper">
   <!-- /.notif -->
   @include('direksi.direksipartials.dbdireksi_notif')
   <!-- Content Wrapper. Contains page content -->
  
      <!-- Sidebar Menu -->
      @include('direksi.direksipartials.dbdireksi_sidebar')
    <!-- /.sidebar -->
  </aside>
              ...
              <div class="timeline">
                ...
                <div>
                  ...
                  <div class="timeline-item">
                    ...
                    <h3 class="timeline-header"><a href="#">Indah Latifah  </a>Pengaduan</h3>
                    ...
                    <div class="timeline-footer">
                      <a class="btn btn-primary btn-sm">Terima</a>
                      <a class="btn btn-danger btn-sm">Tolak</a>
                      <a class="btn btn-success btn-sm">Tanggapi</a>
                    </div>
                  </div>
                </div>
                <!-- END timeline item -->
...
<form action="/upload/proses/{{ $laporan->id}}/update" method="POST">
  @csrf
  @method('PUT')
  <section class="content">
      <div class="container-fluid">
